...
This project is indexed by GitNexus as **MoneyManager** (9728 symbols, 23488 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
