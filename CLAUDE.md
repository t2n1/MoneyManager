...
This project is indexed by GitNexus as **MoneyManager** (9144 symbols, 22072 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
