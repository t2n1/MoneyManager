...
describe('過不足税額 — ca thang 12', () => {
  ...
  it('過不足税額 duong thanh chi thuong', () => {
    const P = {
      period: '202212', kind: 'K', gross: 303345, deduct_total: 56991, net: 218273,
  ...
  it('tu choi khi hoan lon hon tong khau tru (rong > gop)', () => {
    const P = {
      period: '202312', kind: 'K', gross: 485610, deduct_total: 73476, net: 500678,
