...
export function PrivacyToggle({ className }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={
        className ??
        'flex h-9 w-9 items-center justify-center rounded-full border border-border-panel bg-surface text-fg-muted shadow-sm transition active:scale-95 dark:shadow-none'
      }
    >
