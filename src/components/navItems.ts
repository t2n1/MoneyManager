...
import { ChartColumn, NotebookText, Settings, Target, Wallet } from 'lucide-react'
...
//
// ⚠️ Bản 1a có SÁU mục: Bản tin (LayoutDashboard, `/`) đứng trước Sổ (`/so`). Bản tin
// chưa tồn tại — nó là PR 4 — nên ở đây mới năm mục và `/` vẫn là Sổ. Thêm mục thứ sáu
// bây giờ là dựng một nút dẫn tới route không có.
export const NAV_ITEMS: NavItem[] = [
  { to: '/', label: 'Sổ', Icon: NotebookText, onMobile: true },
  ...
  { to: '/settings', label: 'Cài đặt', Icon: Settings, onMobile: true },
]
...
const MONTH_ROUTES = ['/', '/transactions', '/budget', '/reports']
