// Form thêm/sửa tài khoản — tách từ AccountsPage để trang chi tiết tài khoản
// (/assets/account/:id) mở được cùng MỘT form, không nuôi hai bản chép tay.
...
interface FormProps {
  ...
  onClose: () => void
  /** Gọi SAU khi xóa thành công — trang chi tiết dùng để rời khỏi trang đã chết. */
  onDeleted?: () => void
}
