  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-8 bg-surface-page px-6">
      ...
      <button
        ...
        className="flex items-center gap-3 rounded-md border border-border-strong bg-surface px-6 py-3 text-base font-medium text-fg-secondary shadow-sm transition hover:bg-surface-sunken active:scale-95"
      >
