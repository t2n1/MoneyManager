    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-3 gap-2 rounded-xl bg-white dark:bg-gray-900 p-3 text-center shadow-sm">
        <div>
          ...
          <div className="mt-0.5 text-sm font-semibold tabular-nums text-green-600 dark:text-green-400">
            {approx}
        ...
        <div>
          ...
          <div
            className={`mt-0.5 text-sm font-semibold tabular-nums ${yearIncome - yearExpense < 0 ? 'text-red-600 dark:text-red-400' : 'text-gray-800 dark:text-gray-100'}`}
          >
            {approx}
            ...
            {points.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`tabular-nums ${empty ? 'text-gray-300 dark:text-gray-600' : 'text-green-600 dark:text-green-400'}`}>
                  ...
                  <span
                    className={`tabular-nums font-medium ${
                      empty ? 'text-gray-300 dark:text-gray-600' : net < 0 ? 'text-red-600 dark:text-red-400' : 'text-gray-800 dark:text-gray-100'
                    }`}
                  >
