      ...
      >
        ...
        <div className="mt-4 flex justify-end gap-2">
          <button
            type="button"
            onClick={onCancel}
            className="min-h-11 rounded-md px-4 py-2.5 text-sm font-medium text-fg-secondary hover:bg-surface-sunken active:scale-95"
          >
          ...
          <button
            ...
            className={`min-h-11 rounded-md px-4 py-2.5 text-sm font-semibold active:scale-95 disabled:opacity-50 ${
