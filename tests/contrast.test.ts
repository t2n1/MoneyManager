...
describe('contrast: cách viết đã bị đo là trượt AA', () => {
  ...
  // ĐÃ BỎ: phép thử "mực chữ ô lịch chi tiêu" (bảng LEVEL_INK của SpendHeatmapCard).
  // File đó xoá ngày 2026-08-21 cùng lúc thẻ "Chi từng ngày" lên trang Bản tin — cùng một
  // bộ số, và đường đọc ra ngày đỉnh còn lịch chỉ đọc ra đậm/nhạt. Thang nền một-sắc-bốn-
  // độ-mờ mà B9 chốt không còn chỗ nào dùng, nên không có gì để canh nữa.
})
